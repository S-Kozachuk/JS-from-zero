...
*/
/*
Использование "висячей запятой"
это хорошая практика т.к. позволяет
менять порядок элементов без
появления ошибок.
*/
// или
...
// 1:20 Получение значений
/*
Для получения значений массива используются квадратные скобки.
Необходимо обратиться к переменной, которой присвоен данный массив.
Внутри квадратных скобок указать позицию либо ключ-значение,
...
console.log(arrTwo[1].type); // свойство искомого значения
console.log(arrTwo[2]);
console.log(arrTwo[3]);
arrTwo[3](); // вызов функции из массива
*/

// 3:15 Многомерные массивы
/*
let matrix = [
    [1, 2, 3],
    [4, 5, 6],
...
/*
В первых [] скобках указывается
элемент массива (который, также
является массивом).
Во-вторых [] скобках указывается
позиция значения внутри элемента
массива.
*/
